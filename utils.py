...
def pad_sents_char(sents, char_pad_token):
    ...
    for sent in sents:
        sent_padded = []
        for word in sent:
            sent_padded.append(word + [char_pad_token] * (max_word_length - len(word)))
        sents_padded.append(sent_padded+[[char_pad_token]*max_word_length]*(max_sent_length-len(sent_padded)))
